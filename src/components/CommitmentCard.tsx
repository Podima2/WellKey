        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-3">
              <h4 className="text-xl font-bold text-white tracking-tight">{commitment.description}</h4>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="flex items-center space-x-1 text-xs text-neutral-400 hover:text-neutral-300 transition-colors font-medium"
              >
                ...
                <div className="animate-scale-in">
                  <form onSubmit={handleReveal} className="space-y-4">
                    ...
                    <div className="flex space-x-3">
                      <button
                        type="submit"
                        className="flex-1 bg-gradient-to-r from-green-700 to-emerald-700 hover:from-green-600 hover:to-emerald-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 tracking-tight"
                      >
                      ...
                      <button
                        ...
                        className="px-6 py-3 bg-neutral-800 hover:bg-neutral-700 text-white rounded-xl transition-colors font-medium"
                      >
                        Cancel
                      </button>
                    </div>
